...
export const DYNAMIC_CLICK_ANIMATION_NONE_ID: 0
export const DYNAMIC_CLICK_ANIMATION_NONE_IDS: readonly [0]
...
export function isDynamicClickAnimationDisabled(item?: { clickAnimationIds?: unknown }): boolean

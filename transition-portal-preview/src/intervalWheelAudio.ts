...
const prepareIntervalWheelAudio = () => {
  try {
    ...
    if (context.state !== 'running') {
      // Starting a silent source inside pointerdown makes iPad Safari treat this
      // interaction as the explicit audio-unlock gesture.
